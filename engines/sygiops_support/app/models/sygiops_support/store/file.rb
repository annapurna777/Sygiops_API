...
=end
    ...
    def content
      "SygiopsSupport::Store::Provider::#{provider}".constantize.get(sha)
    end
...
=end
    ...
    def self.move(source, target, delay = nil)
      adapter_source = "SygiopsSupport::Store::Provider::#{source}".constantize
      adapter_target = "SygiopsSupport::Store::Provider::#{target}".constantize
    ...
    def destroy_provider
      "SygiopsSupport::Store::Provider::#{provider}".constantize.delete(sha)
    end
  end
end
end
