...
class Ticket::Article < ApplicationRecord
  include Concerns::CanBeImported
  include Concerns::HasActivityStreamLog
  include Concerns::ChecksClientNotification
  include Concerns::HasHistory
  include Concerns::ChecksHtmlSanitized
  include Concerns::CanCsvImport
  include Concerns::CanCloneAttachments
  include Concerns::HasObjectManagerAttributesValidation
  ...
  belongs_to :type,       class_name: 'SygiopsSupport::Ticket::Article::Type', optional: true
  belongs_to :sender,     class_name: 'SygiopsSupport::Ticket::Article::Sender', optional: true
  # belongs_to :created_by, class_name: 'SygiopsSupport::User', optional: true
  # belongs_to :updated_by, class_name: 'SygiopsSupport::User', optional: true
  belongs_to :origin_by,  class_name: 'SygiopsSupport::User', optional: true
