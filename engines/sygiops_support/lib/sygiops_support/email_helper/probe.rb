...
#   )
#
# returns on suresources :channel_emails do
#     collection do
#       post :probe
#       # get :get_keys
#       # post :save_master_data
#       # get :delete_master_data
#       # get :master_data_list
#     end
#   endccess
#
#   {
...
# =end
    ...
    def self.inbound(params)
      ...
      result_inbound = {}
      begin
        require_dependency "sygiops_support/channel/driver/imap.rb"

        # driver_class    = "Channel::Driver::#{adapter.to_classname}".constantize
        #
        driver_class    = "Channel::Driver::Imap"
        driver_instance = SygiopsSupport::Channel::Driver::Imap.new
...
# =end
    ...
    def self.outbound(params, email, subject = nil)
      ...
      # test connection
      begin
        require_dependency "sygiops_support/channel/driver/smtp.rb"

        # driver_class    = "Channel::Driver::#{adapter.to_classname}".constantize
        driver_instance = SygiopsSupport::Channel::Driver::Smtp.new
