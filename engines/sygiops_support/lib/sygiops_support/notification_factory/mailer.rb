...
#
  ...
  #   recipient:    SygiopsSupport::User.find(3),
...
# =end
  ...
  def self.send(data)
    ...
    # sender = "annapurna.tiwari1998@gmail.com" #"Notification Master <noreply@localhost>" #Setting.get('notification_sender')
    sender = "Sygiops Support <noreply@localhost>"
    # in_reply_to = nil
